  ...
  return (
    <section className="bg-gray-100 py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-5 gap-4 items-end p-8 rounded-lg shadow-md bg-gray-800">
          <div>
            <Dropdown
              value={selectedMake}
              options={makes}
              ...
              className="w-full md:w-14rem rounded-lg p-2 shadow-sm focus:border-blue-400 focus:ring focus:ring-blue-200 transition duration-200 ease-in-out"
            />
          </div>
          <div>
            <Dropdown
          ...
          <Button
            label="Search"
            className="w-full bg-red-500 text-white py-3 px-6 rounded-lg font-bold hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 transition duration-200 ease-in-out"
